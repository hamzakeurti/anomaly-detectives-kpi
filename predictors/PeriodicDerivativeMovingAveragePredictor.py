...
class PeriodicDerivativeMovingAveragePredictor(Predictor):
    ...
    def predict(self, data):
        ...
        values = np.append(values[-self.width:], values)
        values = values[self.width:] - values[:len(data.value.values)]
